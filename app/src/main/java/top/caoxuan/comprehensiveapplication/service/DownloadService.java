...
@Deprecated
public class DownloadService extends Service implements BaseService {
    ...
    private DownloadListener listener = new DownloadListener() {
        ...
        public void onSuccess() {
            ...
            Uri apkUri = FileProvider.getUriForFile(DownloadService.this, "top.caoxuan.comprehensiveapplication.fileprovider", file);
    ...
    public class DownloadBinder extends Binder {
        ...
        public void startDownload(String url) {
            ...
            if (downloadTask == null) {
                ...
                downloadTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, downloadUrl, DownloadService.this);
